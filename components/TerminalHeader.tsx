...
export const TerminalHeader: React.FC = () => {
  return (
    <div className="border-b border-slate-800/60 bg-slate-950/40 p-5 backdrop-blur-xl sticky top-0 z-50">
      <div className="flex justify-between items-center max-w-7xl mx-auto">
        <div className="flex items-center gap-4">
          <div className="flex items-center justify-center w-8 h-8 bg-cyan-600 rounded-lg shadow-[0_0_15px_rgba(8,145,178,0.2)]">
